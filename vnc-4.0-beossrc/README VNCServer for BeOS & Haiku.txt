...
Version 1.34, October 2019: Increase a size limit so it can handle 8K pixel wide screens.  Formerly it was limited to 2048 pixels wide, which is barely enough for High Definition 1920x1080 screen sizes.  Comes in useful for multiple monitor support in virtual machines too (make a really wide virtual screen then use VNC to display it over the host's multiple monitor screens).
